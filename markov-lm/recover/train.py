...
from markov_lm.Model_MRF import  PerturbModel
...
def init_conf(CUDA):
    ...
    conf.model = model = PerturbModel(total_length=dataset.total_length(),min_len=dataset.min_len,graph_dim = dataset.english_vocab_len,mixture_count=conf.mixture_count,
        optimizer_factory= conf.optimizer_factory,
